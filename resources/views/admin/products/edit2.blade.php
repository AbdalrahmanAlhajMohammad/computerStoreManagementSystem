        ...
        <div class="col-md-12">
            <div class="portlet light bordered">
                ...
                <div class="portlet-body form">
                    <form class="form-horizontal" v-on:reset="resetDynamicInputs()" role="form" action="{{route('products.update',$product->id)}}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="tab-content form-body">
                            <div class="tab-pane fade in active" id="tab_1_1">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" value="{{$product->ar_name}}" placeholder="@lang('products.enter_name_placeholder')" name="ar_name">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <textarea class="form-control" name="ar_description" rows="3">{{$product->ar_description}}</textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <input type="checkbox" {{$product->active?'checked':''}} name="active" class="make-switch" checked data-on-color="primary" data-off-color="info" value="1">                                </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9" v-show="highlights.length>0" >
                                        <div class="row margin-bottom-5" v-for="(item,index) in highlights" >
                                            <div class="col-md-11">
                                                ...
                                                <input type="hidden" name="highlights.id" v-model="item.id">
                                            </div>
                                            <div class="col-md-1">
                                        ...
                                        <table class="tabel  table-striped fixed-table" style="width: 100%;">
                                            ...
                                            <tr v-for="(item,index) in specifications" v-if="specifications.length>0" class="">
                                                ...
                                                <td class="col-md-3 text-center padding-tb-10">
                                                    <input type="hidden">
                                                    <input type="text" class="form-control" v-model="item.specification.title"  placeholder="@lang('products.enter_specification_title_placeholder')"  v-bind:name="`specifications[${index}][title]`">
                                                </td>
                                                <td class="col-md-3 text-center">
                                                    <input type="text" class="form-control" v-model="item.specification.content"   placeholder="@lang('products.enter_specification_content_placeholder')" v-bind:name="`specifications[${index}][content]`">
                                                </td>
                                                <td class="col-md-3 text-center">
                                                ...
                                                <td class="col-md-9 text-center">
                                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                                        ...
                                                        <div>
                                                            ...
                                                            <input type="hidden" :name="`images[${index}][id]`" v-model="item.id">
                                                            <a href="javascript:;" class="btn red fileinput-exists" data-dismiss="fileinput"> @lang('operations.remove') </a>
                                                        </div>
                                                    </div>
                                                </td>
        ...
        var app=new Vue({
            ...
            data:{
                highlights:[
                    ...
                    {'id':'{{$highlight->id}}','highlight':'{{$highlight->context}}'},
                    @endforeach
                ],
                specifications:[
                        @foreach($product->specifications as $specification)
                    {'specification':{'title':'{{$specification->title}}','content':'{{$specification->content}}'}},
                    @endforeach
                ],
                images:[
                        @foreach($product->images as $image)
                    {'id':'{{$image->id}}','image':'{{$image->getImagePathAttribute()}}','title':'{{$image->title}}'},
                    @endforeach
                ],
                myFiles: ['']
            },
